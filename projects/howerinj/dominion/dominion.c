...
int adventurerCard(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int *temphand, int z) {
	...
	// The below line has an error. It should be == 0
        // Error introduced as part of HW2
...
int smithyCard(int i, int currentPlayer, struct gameState *state, int handPos ) {
      ...
      //+3 Cards
      // The for loop has an error.  The i should start at zero, not two
      // This error was introduced as part of HW2
      for (i = 2; i < 3; i++)
	{
	  drawCard(currentPlayer, state);
	}
...
int villageCard(struct gameState *state, int handPos, int currentPlayer){
      ...
      //+2 Actions
      // The below line has been modified to introduce an error
      // It should be a +2
...
int stewardCard(int choice1, int currentPlayer, struct gameState *state, int choice2, int choice3, int handPos){
	...
	{
	  //+2 coins
	  // This is the original line - state->coins = state->coins + 2;
	  // The below two lines are errors introduced in HW2
	  drawCard(currentPlayer, state);
	  drawCard(currentPlayer, state);
	}
      else
